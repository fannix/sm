...
train_file = "data_svm_regression/5trainset_libsvm/train.libsvm"
...
scores = cross_validation.cross_val_score(clf, X_train, y_train, f1_score, cv = 10)
print scores.mean()
scores = cross_validation.cross_val_score(clf, X_train, y_train, zero_one_score, cv = 10)
print scores.mean()
